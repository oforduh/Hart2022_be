export const html3 = (redeem, Sender_Name, message) => {
  const goodwillMsg = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
      <html
      ...
      >
        ...
        <body>
          <center
            ...
            data-body-style="font-size:14px; font-family:inherit; color:#000000; background-color:#0D342E;"
          >
            <div class="webkit">
              <table
                cellpadding="0"
                                                          ...
                                                          <tr>
                                                            ...
                                                            >
                                                              <img
                                                                ...
                                                                data-proportionally-constrained="true"
                                                                data-responsive="false"
                                                                src="https://hart2022.com/static/media/NavLogo.443c817033c9dd9d4e26.jpg"
                                                                height="33"
                                                              />
                                                            </td>
                                                          </tr>
